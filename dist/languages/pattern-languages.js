import { extendGrammar, insertBefore } from "./pattern-engine.js";
const clikeGrammar = {
    "comment": [
...
if (Array.isArray(tsKeyword)) {
    tsKeyword.push(/\b(?:abstract|declare|is|keyof|readonly|require)\b/, /\b(?:asserts|infer|interface|module|namespace|type)\b(?=\s*(?:[{_$a-zA-Z\xA0-\uFFFF]|$))/, /\btype\b(?=\s*(?:[\{*]|$))/);
}
...
typescriptGrammar["class-name"].inside = typeInside;
...
//# sourceMappingURL=pattern-languages.js.map