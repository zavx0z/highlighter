import type { TokenizeOptions, Tokens } from "../tokens.ts";
...
export declare function tokenizeHtmlPattern(lines: readonly string[], options?: TokenizeOptions): Tokens;
export declare function tokenizeMarkdownPattern(lines: readonly string[], options?: TokenizeOptions): Tokens;
